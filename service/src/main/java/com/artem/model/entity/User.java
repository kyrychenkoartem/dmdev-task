...
public class User {
    ...
    public String toString() {
        return "User(id=" + this.getId() + ", firstName=" + this.getFirstName() + ", lastName=" + this.getLastName() + ", email=" + this.getEmail() + ", password=" + this.getPassword() + ", birthDate=" + this.getBirthDate() + ", role=" + this.getRole() + ")";
    }
